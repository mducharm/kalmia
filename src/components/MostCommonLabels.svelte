...
<section
  class="bg-gradient-to-b from-blue-100 to-blue-300 p-5 py-10 mt-6 text-left transform duration-500 hover:-translate-y-1 hover:shadow-xl cursor-pointer bg-gray-100 divide-y border-2"
>
  <div>
